<form action="{{ route('pages.update', $page->id)}}" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="field">
            ...
            <div class="control">
                <textarea class="tinymce" id="page-html_<?=$langCode?>" name="html_<?=$langCode?>" cols="30" rows="10"><?=old("html_{$langCode}", $page->{'html_' . $langCode})?></textarea>
            </div>
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input type="text" class="input" name="url_<?=$langCode?>" id="page-url_<?=$lang?>" value="<?=old("url_{$langCode}", $page->{'url_' . $langCode})?>" minlength="5" maxlength="200" placeholder="" inputmode="text" autocomplete="off">
                <span class="icon is-small is-left">
                    <i class="fas fa-bullhorn"></i>
                </span>
            </div>
